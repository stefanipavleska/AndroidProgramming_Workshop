...
public class ProveriPrisustvoSiteActivity extends AppCompatActivity {
    SQLiteDatabase db;
    ListView listView;
    String currentDay;
    String []days;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_proveri_prisustvo_site);
    ...
    private List<String> fetchDataFromDatabase() {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM prisustvo", null);
