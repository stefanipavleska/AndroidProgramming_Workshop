...
public class MomentalniTerminiAcitivity extends AppCompatActivity {
    SQLiteDatabase db;
    ListView listView;
    String currentDay;
    String []days;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_momentalni_termini_acitivity);
    ...
    private List<String> fetchDataFromDatabase() {
        ...
        Cursor cursor = db.rawQuery("SELECT * FROM termin WHERE  den = '" + currentDay + "' AND odterminHour <= '" + currentHour + "'AND doterminHour >= '" + currentHour + "'", null);
